...
import { ArrowLeft, CheckCircle2, FileText, Minus, Plus, ChevronLeft, ChevronRight, ChevronDown } from "lucide-react"
...
export function ProductDetailView({ product, unit }: ProductDetailViewProps) {
